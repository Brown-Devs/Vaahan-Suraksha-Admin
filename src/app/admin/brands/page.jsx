...
function page() {
    ...
    const StatCard = ({ title, value, Icon, color }) => (
        <div className="bg-card border border-gray-300 rounded-xl px-5 py-8 flex justify-between items-center hover:border-gray-300 duration-200 ease-in-out transition">
            <div>
    ...
    return (
        <InnerDashboardLayout>
            ...
            {/* Search + Filters */}
            <div className="bg-background p-6 border border-gray-300 rounded-xl mb-6">
                {/* <div className="mb-5 flex items-center justify-between">
                    <div>
